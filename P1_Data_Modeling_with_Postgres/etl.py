...
def process_song_file(cur, filepath):
    ...
    - Inserts data into Artist and Song tables
    """
    # open song file
...
def process_log_file(cur, filepath):
    ...
    - Inserts data into Time, User, and Songplay tables
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
...
def process_data(cur, conn, filepath, func):
    """
    - Gets files in the directory with a .json extension
    - Prints out the number of files found and then proccessed in the command window
    """
...
def main():
    ...
    - Processes files using functions defined above
    - Closes connection
    """
